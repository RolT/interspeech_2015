...
\veryHuge \color{NavyBlue} \textbf{Hybrid DTW-ABnet System} \color{Black}\\ % Title
\Huge\textit{Finding words to learn segments}\\[2cm] % Subtitle
\huge \textbf{Roland Thiolliere, Ewan Dunbar, Gabriel Synnaeve, Maarten Versteegh, Emmanuel Dupoux}\\[0.5cm] % Author(s)
\huge Ecole Normale Superieure / PSL Research University / EHESS / CNRS, France\\[0.4cm] % University/organization
\Large \texttt{rolthiolliere@gmail.com}\\
\end{minipage}
%
